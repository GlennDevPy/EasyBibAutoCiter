...
def singleL():
    ...
    checklist = {
        "contentTitleFound": title,
        "mediumTitleFound": webtitle,
        "authorF": authorF,
        "authorL": authorL,
        "dD": dD,
        "dM": dM,
    ...
    tocheckdict = {
        "mediumTitleFound": "Website Title?",
        "contentTitleFound": "Article Title?",
        "contributorsFound": "Author?", #ask for first and last
        "publishedDayFound": "Published Day?",
        "publishedMonthFound": "Published Month?",
        "publishedYearFound": "Published Year?"
    }
    ...
    if score == "100":
        ...
        for plz in tocheck:
            ...
            if xPlz == "0":
                check.append(tocheckdict[plz])
            else:
                pass
        print(check)
        input()    
        #check which ones are 0 for the XXXFound
        #maybe switch the checklist in to the tocheckdict so that you can ask input later
